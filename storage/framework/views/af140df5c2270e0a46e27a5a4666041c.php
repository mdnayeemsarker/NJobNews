    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-4">
            <div class="small-box bg-danger">
                ...
                <a href="<?php echo e(route('track.visitor')); ?>" class="small-box-footer">More info <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-2 col-4">
            <div class="small-box bg-info">
                ...
                <a href="<?php echo e(route('roles.index')); ?>" class="small-box-footer">More info <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-2 col-4">
            ...
            <div class="row">
                <div class="col-lg-4 col-4">
                    <div class="small-box bg-warning">
                        ...
                        <a href="<?php echo e(route('upload.index')); ?>" class="small-box-footer">More info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 col-4">
                    <div class="small-box bg-danger">
                        ...
                        <a href="<?php echo e(route('ads.index')); ?>" class="small-box-footer">More info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 col-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-center">
                            <input type="text" class="knob" data-readonly="true"
                                value="<?php echo e($jobStatistics['todayPercent']); ?>" data-width="100" data-height="100"
                                data-fgColor="#39CCCC">
                        ...
                        <div class="col-4 text-center">
                            <input type="text" class="knob" data-readonly="true"
                                value="<?php echo e($jobStatistics['last7DaysPercent']); ?>" data-width="100" data-height="100"
                                data-fgColor="#39CCCC">
                        ...
                        <div class="col-4 text-center">
                            <input type="text" class="knob" data-readonly="true"
                                value="<?php echo e($jobStatistics['last15DaysPercent']); ?>" data-width="100" data-height="100"
                                data-fgColor="#39CCCC">
