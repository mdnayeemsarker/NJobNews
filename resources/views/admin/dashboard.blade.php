    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-4">
            <div class="small-box bg-danger">
                ...
                <a href="{{ route('track.visitor') }}" class="small-box-footer">More info <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-2 col-4">
            ...
            <div class="row">
                <div class="col-lg-6 col-6">
                    <div class="small-box bg-warning">
                        ...
                        <a href="{{ route('upload.index') }}" class="small-box-footer">More info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-6 col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-center">
                            <input type="text" class="knob" data-readonly="true"
                                value="{{ $jobStatistics['todayPercent'] }}" data-width="100" data-height="100"
                                data-fgColor="#39CCCC">
                        ...
                        <div class="col-4 text-center">
                            <input type="text" class="knob" data-readonly="true"
                                value="{{ $jobStatistics['last7DaysPercent'] }}" data-width="100" data-height="100"
                                data-fgColor="#39CCCC">
                        ...
                        <div class="col-4 text-center">
                            <input type="text" class="knob" data-readonly="true"
                                value="{{ $jobStatistics['last15DaysPercent'] }}" data-width="100" data-height="100"
                                data-fgColor="#39CCCC">
