    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <textarea class="form-control" rows="2" readonly>{{ $smsWorker->body }}</textarea>
                </div>
            </div>

            {{-- Second Message Body --}}
            <div class="form-group row">
                <label class="col-lg-3 font-weight-bold">Second Message Body</label>
                <div class="col-lg-9">
                    <textarea class="form-control" rows="2" readonly>{{ $smsWorker->body_second }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <textarea class="form-control" rows="3" readonly>{{ $smsWorker->first_sms ?? 'Waiting' }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <textarea class="form-control" rows="3" readonly>{{ $smsWorker->second_sms ?? 'Waiting' }}</textarea>
                </div>
            </div>
        ...
        <div class="card-footer">
            <a href="{{ route('sms-workers.complete', $smsWorker->id) }}" @disabled($smsWorker->status != 'wait')
                class="btn btn-primary @if ($smsWorker->status != 'wait') disabled btn-secondary @endif">
                Complete
            </a>
